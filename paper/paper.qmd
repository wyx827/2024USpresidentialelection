...
### Poll Aggregation
This survey will be combined with results from reputable polling firms (e.g., YouGov, Ipsos, Gallup) to strengthen the forecast through a **poll-of-polls** approach [@pew_survey_methodology].
...
# Display the full summary table using kable, excluding "F-statistic p-value" row
library(knitr)
