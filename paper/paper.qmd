...
ggplot(analysis_data %>% filter(sample_size < 3000), aes(x = sample_size)) +
  geom_histogram(binwidth = 100, fill = "pink", color = "white", alpha = 0.7) +
...
ggplot(analysis_data %>% 
  ...
  geom_histogram(binwidth = 1, fill = "pink", color = "white", alpha = 0.7) + 
...
ggplot(analysis_data, aes(x = as.Date(end_date))) + 
  geom_line(stat = "count", color = "pink", size = 1) + 
