...
@fivethirty provides the data. @tidyverse, @ggplot2, @knitr
This project was made possible by a variety of R packages that provided essential tools and functionality. We thank the @tidyverse and @ggplot2 teams for their extensive suite of tools for data manipulation and visualization, which were instrumental in data cleaning and graphing. We also acknowledge @usmap for its support in creating U.S. geographic visualizations, and @corrplot for facilitating clear, informative correlation plots. Finally, @arrow was crucial for efficient data storage and handling with Parquet files, ensuring data integrity throughout the project. We are grateful to the developers and maintainers of these packages for their contributions to open-source software, which greatly enhanced the scope and depth of our analysis.
