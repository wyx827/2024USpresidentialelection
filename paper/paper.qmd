...
This paper forecasts the 2024 U.S. Presidential Election outcomes between Kamala Harris and Donald Trump, presenting a predicted electoral college outcome based on a fitted model. By analyzing poll data and historical state-level voting patterns, we estimated Trump’s vote percentages across states and calculated projected electoral votes for each candidate. Our model anticipates a significant victory for Harris, who is projected to secure 387 electoral votes compared to Trump’s 151. This finding underscores the impact of demographic and geographic factors on the U.S. electoral landscape.

A geographic visualization further emphasizes the anticipated state-by-state outcomes and reveals enduring regional voting patterns. Key predictors, such as state-level variations and transparency scores, strongly influence polling outcomes for both Donald Trump and Kamala Harris. While our model projects a potential Harris victory with a majority of electoral votes, challenges inherent in electoral predictions remain. We acknowledge that regional variations, particularly in battleground states like Florida and Arizona, introduce uncertainty that may affect the final outcome.
...
## Weakness
Despite the model's strengths, it has limitations, which present a critical challenge and requires further exploration. The assumption of linear relationships between predictors may oversimplify complex voter behaviors and social influences. The dataset simplifies the potentioanl influecne behind the US election. 

Moreover, polling averages, though valuable, are subject to biases that may skew results. For example, factors like nonresponse bias—where certain demographic groups, such as less civically engaged individuals, are less likely to participate—may influence results more heavily in this election cycle. Additionally, reliance on past election data introduces a risk of recency bias, as seen in public expectations shaped by Trump’s unexpected win in 2016 and close finish in 2020. Yet, as Nate Silver notes, intuition or prior election outcomes can be misleading, given the unique dynamics of each election. Polling errors, such as those seen in 2016 and 2020, further emphasize the need for cautious interpretation of our model’s findings.

@silver2024gut also points out that the voters for Trump are less likely to finish the polls because of “Shy Voters”. This may lead to the bias in the survey sample collection. The deficiency of education background and sample credibility both influence the prediction.
