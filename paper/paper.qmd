...
@sec-data explains the data we used to build up the prediction mode.
...
# Appendix A: Pollster Methodology Overview and Evaluation {#sec-appendixA}
...
# Appendix B: Idealized Methodology and Survey {#sec-appendixB}
