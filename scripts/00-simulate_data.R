...
#pollster names
pollster <- c(
  "The New York Times/Siena College", "ABC News/The Washington Post", "Marquette University Law School", "YouGov",
  "Monmouth University Polling Institute", "Marist College", "Suffolk University","Data Orbital", 
  "University of Massachusetts Lowell Center for Public Opinion", "Emerson College", 
  "Muhlenberg College Institute of Public Opinion", "Selzer & Co.", "University of North Florida Public Opinion Research Lab", 
  "CNN","SurveyUSA", "Beacon Research/Shaw & Co. Research", "Quinnipiac University", "MassINC Polling Group", "Ipsos", 
  "Christopher Newport University Wason Center for Civic Leadership", "Siena College","AtlasIntel", "Echelon Insights", 
  ...
  "High Point University Survey Research Center", "Gallup", "Abt Associates", "The Winston Group", "KFF", 
